...
import { features } from "@/app/db/features";
export default function Search() {
  ...
  useEffect(() => {
    const toolList = features;

    const filteredData = toolList.filter(
      (item) => item.title.toLowerCase().includes(searchValue.toLowerCase()), // Filter the JSON data based on the search value
    );
